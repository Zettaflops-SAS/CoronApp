...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
                <a href="#"><i class='fa fa-users'></i> <span>Miembros</span> <i class="fa fa-angle-left pull-right"></i></a>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{ url('/reportegrafico') }}">Reporte Gráfico</a></li>
                    <li><a href="{{ url('/reportedocumento') }}">Reporte Documentos</a></li>
                </ul>
            </li>
        </ul><!-- /.sidebar-menu -->
    </section>
